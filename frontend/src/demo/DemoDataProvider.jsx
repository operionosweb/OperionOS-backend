...
const primaryContract = {
  ...
  financialImpact: {
    ...
    eventDrivenExposure: 1430000,
    potentialAvoidableExposure: 920000,
    potentialProtectedValue: 920000,
    synthetic: true,
    items: [
      {
        id: "fi-return",
        title: "Late aircraft return exposure",
        category: "Grounding / downtime exposure",
        ...
        event: "Aircraft remains unavailable for return for 14 days",
        condition: "Return occurs after the contractual Termination Date",
        baseAmount: 1190000,
        calculation: "€85,000 synthetic daily late-return rate × 14 assumed days",
        variables: [{ label: "Daily late-return rate", value: "€85,000" }, { label: "Assumed duration", value: "14 days" }],
        assumptions: ["The daily rate and 14-day duration are synthetic demonstration assumptions.", "No probability weighting or live operational prediction is applied."],
        consequence: "Potential late-return fees and associated redelivery dispute exposure.",
        actionId: "verify-return",
        action: "Confirm return inspection scope and renegotiate the late-return threshold.",
        exposureAfterAction: 420000,
        protectedValue: 770000,
      },
      {
        id: "fi-maintenance",
        title: "Maintenance records remediation",
        category: "Maintenance-related exposure",
        exposureType: "Event-driven potential exposure",
        riskId: "rk-maint",
        clauseId: "cl-maint",
        obligationId: "ob-records",
        deadlineId: "dl-records",
        evidenceId: "ev-maintenance",
        event: "Technical records remain incomplete for 12 days after a shop visit",
        condition: "Records are not delivered within 10 Business Days",
        baseAmount: 240000,
        calculation: "€20,000 synthetic remediation and delay cost × 12 assumed days",
        variables: [{ label: "Daily remediation cost", value: "€20,000" }, { label: "Assumed delay", value: "12 days" }],
        assumptions: ["The daily remediation cost and delay duration are synthetic demonstration assumptions.", "The estimate is not a prediction of an actual maintenance event."],
        consequence: "Potential remediation cost and delayed redelivery acceptance.",
        actionId: "return-records",
        action: "Maintain an approved return evidence pack before the redelivery window.",
        exposureAfterAction: 90000,
        protectedValue: 150000,
      },
      {
        id: "fi-rent",
